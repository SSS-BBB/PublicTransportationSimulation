...
public class VehiclesTestMap extends MapData {
	...
	public VehiclesTestMap() {
		...
		StopSign[] vanStop = new StopSign[] { 
				new StopSign("Trasport Garage", "A06", new double[] { 34.0/mapScale, 242.0/mapScale }),
				new StopSign("Coco Industry", "A01", new double[] { 116.0/mapScale, 139.0/mapScale }),
		...
		StopSign[] trainStop = new StopSign[] { 
				...
				new TrainStopSign("Tew strip club", "A17", new double[] { 535.0/mapScale, 540.0/mapScale }),
		...
		StopSign[] skyTrainStop = new StopSign[] { 
				...
				new SkyTrainStopSign("Yong Tui strip club", "A21", new double[] { 260.0/mapScale, 318.0/mapScale }),
